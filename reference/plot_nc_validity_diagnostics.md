...
diagnostics. Panels: (A) A1 W perp X \| C, (B) A2 W perp G \| C, (C) A2'
W perp Gm \| C, (D) A3 covariance-capture versus true coverage omega
(with permutation-null mean and the fraction of replicates with
permutation p \< 0.05 on a secondary axis), and (E) A3 support R2(Utilde
\| W) versus omega.
...
- file:
  ...
  Optional file path to save the figure (cairo_pdf, so the omega and
  Utilde glyphs render).
